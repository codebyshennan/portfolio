---
title: Topograph
description: Live portfolio dashboard synced from Carta and AngelList for valuations, MOIC, ownership percentages, and dilution history across multiple funds.
date: 2025-01-01
...
Carta and AngelList don't always agree because of rounding differences, timing mismatches on round closes, and occasional data entry errors. Topograph runs a reconciliation step that flags discrepancies above a configurable threshold (default: 0.5% ownership difference) for manual review.
...
Topograph stores quarterly snapshots of all metrics, enabling trend analysis: MOIC over time, ownership drift, and valuation multiples. The snapshot diff view highlights which companies moved the most quarter-over-quarter, which is useful for LP reporting and internal reviews.
