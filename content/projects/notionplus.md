...
keywords: Notion, Notion agents, productivity tools, app marketplace, widgets, forms
---
...
- Typeform-quality forms that submit directly into Notion databases
- Embeddable widgets for Notion pages and Notion Sites
- Worker packs that give Notion Agents useful external capabilities
- A simple marketplace for discovering and installing these pieces

## Stack

Next.js, React, Tailwind CSS, Notion API, Vercel
