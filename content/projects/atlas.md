---
title: Atlas
description: AI-powered network mapper that models founder and investor relationships as a graph and surfaces warm intro paths at deal time.
date: 2025-03-15
...
4. Context synthesis: summarises the relationship path in natural language: "You to Sarah (co-invested in Fund II deal) to Mark (Stanford MBA '18) to Target Founder"

### Network visualization

Expert profiles have a Connections tab showing known connections grouped by relationship type, alongside an interactive force-directed network graph (react-force-graph-2d). The graph renders live on click, which helps when tracing multi-hop paths before committing to an outreach sequence.
