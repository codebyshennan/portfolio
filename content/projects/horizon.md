...
- Slack over PagerDuty: the team lives in Slack. Adding PagerDuty would mean another tool to check. Slack webhooks with channel-based routing (critical to #ops-alerts, informational to #ops-health) covers the use case.
