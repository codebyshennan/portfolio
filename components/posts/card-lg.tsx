    ...
    >
      <div className="relative overflow-hidden aspect-square">
        ...
        <Menu as="div" className="relative flex justify-between p-4">
          <p
            className="text-xs md:text-sm font-semibold m-0 text-white/80 mt-1"
      ...
      <div className="flex flex-col gap-1 justify-center min-h-16 flex-1 bg-white dark:bg-neutral-900 p-4 text-center">
        <h2 className="text-lg md:text-xl leading-tight font-bold text-black dark:text-white line-clamp-2">
          {post.title}
        </h2>
